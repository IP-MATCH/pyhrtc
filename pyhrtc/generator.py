...
def random_hrtc(number_of_hospitals, number_of_single_residents,
    ...
    hospitals = {ident: Hospital(ident, capacities[ident]) for ident in range(number_of_hospitals)}
    single_residents = {ident: Agent(ident) for ident in range(number_of_single_residents)}
    couple_doctors = {}
